...
<body>
	<div
		...
		<br>
		<a href="ViewProfile"
					style="text-decoration: none; color: white; background: #2e3d8c; border-radius: 50px; font-size: 15px; margin: 10px; padding: 10px; height: 40px;">My
					Profile</a> <br> <br>
		<nav>
	...
	<s:iterator value="beanL">
		<div class="container">
			<br> <a href="SearchUser.jsp"><button
					class="btn btn-primary" style="border-radius: 30px; float: right;">Back
					to Search</button></a> <br> <br> <br> <br>
			<div class="row">
				<div class="column">
					<div class="card">
